export default function index() {
  return (
    (document.title = 'Contact Me | Jeff Huang'),
    (
        ...
        <a href="https://www.youtube.com/@Solderq35" target="_blank" rel="noreferrer" className="a2">
          <button className="bg-blue-600 hover:bg-blue-900 text-white font-bold py-2.5 px-4 rounded my-6 text-2xl mx-5">
            <div className="flex">
              ...
              <div className="ml-3">Youtube (Gaming)</div>
            </div>
          </button>
        </a>
        ...
        >
          <button className="bg-blue-600 hover:bg-blue-900 text-white font-bold py-2.5 px-4 rounded my-6 text-2xl mx-5">
            <div className="flex">
              <div className="flex items-center ...">
                <svg viewBox="0 0 24 24" fill="currentColor" height="1em" width="1em">
                  <path d="M11 2a1 1 0 00-1 1v6a.5.5 0 00.5.5H12a.5.5 0 01.5.5.5.5 0 01-.5.5h-1.5C9.73 10.5 9 9.77 9 9V5.16C7.27 5.6 6 7.13 6 9v1.5A2.5 2.5 0 018.5 13 2.5 2.5 0 016 15.5V17c0 2.77 2.23 5 5 5h2c2.77 0 5-2.23 5-5v-1.5a2.5 2.5 0 01-2.5-2.5 2.5 2.5 0 012.5-2.5V9c0-2.22-1.78-4-4-4V3a1 1 0 00-1-1h-2m-.25 14.5h2.5l-.5 3.5h-1.5l-.5-3.5z" />
                </svg>
              </div>
              <div className="ml-3">Youtube (Violin)</div>
            </div>
          </button>
        </a>
        ...
        <a href="https://space.bilibili.com/1174271590" target="_blank" rel="noreferrer" className="a2">
          <button className="bg-blue-600 hover:bg-blue-900 text-white font-bold py-2.5 px-4 rounded my-6 text-2xl mx-5">
            <div className="flex">
              ...
              <div className="ml-3">Bilibili (Gaming, Chinese)</div>
            </div>
          </button>
        </a>
      </div>
